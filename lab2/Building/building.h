struct Building {
	...
	glm::vec3 scale;		// Size of the Building in each axis

	GLfloat vertex_buffer_data[72] = {  // Vertex definition for a Building on the XZ plane
		// Front face
		-1.0f, 0.0f, 1.0f,
		 1.0f, 0.0f, 1.0f,
		 1.0f, 2.0f, 1.0f,
	...
	GLuint index_buffer_data[36] = {		// 12 triangle faces of a Building
		0, 1, 2,
		0, 2, 3,
	...
	void initialize(glm::vec3 position, glm::vec3 scale, const char* texture_path) {
		...
		programID = LoadShadersFromFile("../lab2/Building/box.vert", "../lab2/Building/box.frag");
		if (programID == 0)
		{
	...
	void render(glm::mat4 cameraMatrix) {
        ...
        // Scale the Building along each axis to make it look like a building
